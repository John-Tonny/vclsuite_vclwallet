...
func (m *mockChainClient) Rescan(*chainhash.Hash, []vclutil.Address,
	map[wire.OutPoint]vclutil.Address) error {
	return nil
}

func (m *mockChainClient) NotifyReceived([]vclutil.Address) error {
	return nil
}
