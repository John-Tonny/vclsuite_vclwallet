...
type RescanJob struct {
	...
	OutPoints   map[wire.OutPoint]vclutil.Address
...
// rescan.
func (w *Wallet) Rescan(addrs []vclutil.Address, unspent []wtxmgr.Credit) error {
...
func (w *Wallet) rescanWithTarget(addrs []vclutil.Address,
	unspent []wtxmgr.Credit, startStamp *waddrmgr.BlockStamp) error {

	outpoints := make(map[wire.OutPoint]vclutil.Address, len(unspent))
